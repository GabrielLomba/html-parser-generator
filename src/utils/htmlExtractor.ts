...
function isLikelyId(segment: string): boolean {
    ...
    const commonPathWords = [
        'about', 'contact', 'services', 'products', 'support', 'help', 'login', 'register',
        'profile', 'account', 'settings', 'dashboard', 'admin', 'manage', 'create', 'edit',
        'delete', 'update', 'search', 'filter', 'category', 'categories', 'archive', 'archives',
        'download', 'downloads', 'upload', 'uploads', 'media', 'images', 'videos', 'files',
        'document', 'documents', 'report', 'reports', 'analytics', 'statistics', 'metrics',
        'dashboard', 'overview', 'summary', 'details', 'preview', 'history', 'timeline',
        'calendar', 'schedule', 'events', 'notifications', 'messages', 'inbox', 'outbox',
        'trash', 'recycle', 'backup', 'restore', 'export', 'import', 'sync', 'connect',
        'disconnect', 'configure', 'configuration', 'preferences', 'options', 'advanced',
        'security', 'privacy', 'terms', 'conditions', 'policy', 'policies', 'legal',
        'copyright', 'trademark', 'patent', 'license', 'licenses', 'agreement', 'contract'
    ];
